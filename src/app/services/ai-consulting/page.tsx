...
const plans = [
  {
    ...
    featureNote: {
      label: "2業務で10%引き・3業務以上で15%引き",
      items: [
        "業務の内容によって金額は変わります（上記は参考価格です）",
        "割引後の端数は1万円単位に切り下げてご提示します",
  ...
  },
  {
    ...
    price: "¥200,000",
    priceNote: "税別 / 初期費用（2業務・10%引き後）",
    featured: true,
    ctaLabel: "お申し込み",
    ctaHref: "/#contact",
    features: [
      "単品でそろえると¥230,000のところ、10%引き＋端数切り下げ",
      ...
      <main className="min-h-screen bg-[#0f1e24]">
        ...
        <PricingExampleToggle
          ...
          <p className="text-center text-white/45 text-sm mt-12 max-w-3xl mx-auto leading-relaxed">
            ...
            上記は業務ごとの参考価格で、2業務をお選びの場合は合計から10%、3業務以上は15%を割り引いてご提示します。<br className="hidden md:block" />
            割引後の端数は1万円単位に切り下げます。最終的なお見積りはヒアリングのうえでご提示します。
          </p>
