...
const faqs = [
  ...
  },
  {
    ...
    items: [
      {
        q: "料金はどのように決まりますか？",
        a: "AIに任せる業務の内容によって変わります。参考価格として、メール対応が¥150,000、見積書の作成が¥120,000、シフト作成が¥100,000、打ち合わせの議事録・日報や作業報告書・契約書や規程のチェックが各¥80,000、飲食店向けの発注予測と引き継ぎ資料づくりが各¥250,000（いずれも税別）です。複数の業務をまとめてご依頼の場合は、2業務で合計から10%、3業務以上で15%を割り引いてご提示します。御社に必要な業務だけを選んでいただくため、最終的なお見積りはヒアリングのうえでご提示します。",
      },
      {
        q: "まとめて頼むと、いくらになりますか？",
        a: "業務の数に応じて、合計から割り引いてご提示します。2業務で10%引き、3業務以上で15%引きです。たとえばメール対応（¥150,000）と打ち合わせの議事録（¥80,000）の2業務なら、合計¥230,000から10%引いて¥207,000となりますが、割引後の端数は1万円単位に切り下げるため、¥200,000（税別）でのご提供となります。1業務のみの場合は参考価格のままです。",
      },
      {
        q: "「1業務」とはどの範囲ですか？",
