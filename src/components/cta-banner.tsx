  ...
  return (
    ...
    >
      <div ref={ref} className="max-w-[900px] mx-auto px-5 text-center">
        <h2 className={`text-navy text-2xl md:text-4xl font-bold mb-6 transition-all duration-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          まず、話してみませんか。
        </h2>
        <p className={`text-navy/70 text-base md:text-lg mb-10 transition-all duration-600 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
