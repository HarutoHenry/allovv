  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-8 py-5 flex items-center justify-between">
        {/* Logo */}
        <Link href="/" className="flex items-center ml-[40px]">
          <Image
            src="/logo.png"
            alt="Allovv"
            width={160}
        ...
        <button
          ...
          className="hidden md:inline-flex px-5 py-2.5 gradient-btn font-medium text-sm rounded-full transition-all mr-[40px]"
        >
          お問い合わせ
        </button>
