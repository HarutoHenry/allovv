...
const faqs = [
  ...
  },
  {
    ...
    items: [
      {
        q: "料金はどのように決まりますか？",
        a: "AIに任せる業務の内容によって変わります。参考価格として、メール対応が¥150,000、見積書の作成が¥120,000、シフト作成が¥100,000、打ち合わせの議事録・日報や作業報告書・契約書や規程のチェックが各¥80,000、飲食店向けの発注予測と引き継ぎ資料づくりが各¥250,000（いずれも税別）です。2業務以上をお選びの場合は、合計から一式価格でご提示します。御社に必要な業務だけを選んでいただくため、最終的なお見積りはヒアリングのうえでご提示します。",
      },
      {
        q: "「1業務」とはどの範囲ですか？",
