...
const faqs = [
  ...
  },
  {
    ...
    items: [
      {
        q: "料金はどのように決まりますか？",
        a: "AIに任せる業務の数で決まります。1業務あたり¥120,000（税別）、業務2つの導入パックが¥198,000（1業務あたり¥99,000）、3業務目からは1業務¥90,000で追加いただけます。御社に必要な業務だけを選んでいただくため、最終的なお見積りはヒアリングのうえでご提示します。",
      },
      {
        q: "「1業務」とはどの範囲ですか？",
        a: "ひとつの仕事の流れ（たとえば「見積書の作成」「問い合わせへの返信」「月末の請求書作成」）を、AIが下書きまで用意する状態にするまでを1業務としています。業務フローのヒアリング・システム構築・テスト運用・操作レクチャーまでが含まれます。",
      },
      {
        q: "月々の費用はかかりますか？",
