  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-8 pt-[22px] pb-3 flex items-end">
        ...
        {/* Desktop Nav — 中央1/3 */}
        <div className="hidden md:flex items-center justify-center gap-[38px] translate-y-[3px]">
          {navLinks.map((link) => (
            <LiquidNavItem
              key={link.href}
              label={link.label}
        ...
        {/* CTA Button — 右1/3 */}
        <div className="flex-1 hidden md:flex items-center justify-end pr-[60px] lg:pr-[68px] 2xl:pr-[60px] translate-y-[8px]">
          <button
