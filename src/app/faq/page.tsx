...
export const metadata = {
  title: "よくあるご質問",
  description:
    "AllovvのAI仕組み化サービスに関するよくあるご質問です。セキュリティ・誤送信対策・導入期間・費用などにお答えします。",
}
...
const faqs = [
  ...
  },
  {
    ...
    items: [
      {
        q: "料金はどのように決まりますか？",
        a: "AIに任せる業務の内容によって変わります。参考価格として、メール対応が¥150,000、見積書の作成が¥120,000、シフト作成が¥100,000、打ち合わせの議事録と契約書や規程のチェックが各¥80,000、飲食店向けの発注予測と、事業承継・引き継ぎを楽にする業務AI化が各¥250,000（いずれも税別）です。複数の業務をまとめてご依頼の場合は、合計から割り引いた一式価格でご提示します。御社に必要な業務だけを選んでいただくため、最終的なお見積りはヒアリングのうえでご提示します。",
      },
      {
        q: "「1業務」とはどの範囲ですか？",
      ...
      {
        q: "導入後のサポートはありますか？",
        a: "導入後1ヶ月間のサポート（調整・改善・質問対応）がパッケージに含まれています。その後も継続をご希望の場合は、月額¥30,000（税別）の保守プランから運用契約をご用意しています。月次レポートと月1回の改善打ち合わせまで含めた運用改善プラン、手順書の改訂や新任レクチャーまで含めた標準化プランもございますので、必要な範囲に合わせてお選びいただけます。",
      },
      {
        q: "途中でやめることはできますか？",
      ...
      <main className="min-h-screen bg-white">
        <div className="pt-36 pb-24 max-w-[720px] mx-auto px-5">
          ...
          <p className="text-navy/50 text-sm text-center mb-16 leading-relaxed">
            AI仕組み化サービスについて、よくいただくご質問をまとめました。
          </p>
